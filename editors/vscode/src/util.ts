...
export function getZiggyPath(): string {
    const configuration = workspace.getConfiguration("ziggy");
    const ziggyPath = configuration.get<string>("path");
    return getExePath(ziggyPath, "ziggy", "ziggy.path");
}
